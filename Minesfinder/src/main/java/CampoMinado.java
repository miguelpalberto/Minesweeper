...
public class CampoMinado {
    ...
    public void revelarQuadricula(int x, int y) {
        ...
        if (minas[x][y]) {
            ...
            int numMinasVizinhas = contarMinasVizinhas(x, y);
    ...
    public void revelarQuadriculasVizinhas(int x, int y) {
        if (x-1 >= 0 && x-1 < nrLinhas && y-1 >= 0 && y-1 < nrColunas ) {
            revelarQuadricula(x - 1, y - 1);}
        if (x >= 0 && x < nrLinhas && y-1 >= 0 && y-1 < nrColunas ) {
            revelarQuadricula(x, y - 1);}
        if (x+1 >= 0 && x+1 < nrLinhas && y-1 >= 0 && y-1 < nrColunas ) {
            revelarQuadricula(x + 1, y - 1);}
        if (x-1 >= 0 && x-1 < nrLinhas && y >= 0 && y < nrColunas ) {
